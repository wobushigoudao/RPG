...
<link rel="stylesheet" type="text/css"
	href="/RPG/css/tanxian/zhuangbeicaozuo.css" charset="utf-8" />
...
<body>
	<table align="center" width="140" height="100%" cellspacing="0"
		cellpadding="0">
		<tr>
			<td align="center" width="60px" height="29px"><a
				onclick="diuqizhuangbei()" href="#" style="color: red;">丢弃</a></td>
			<td align="center" width="60px" height="29px"><a
				onclick="xiangqing()" href="#" style="color: red;">物品详情</a></td>
		</tr>
		<tr>
			<td align="center" height="29px"><a style="color: red;"
				onclick="waifanhui()" href="#">返回</a></td>
			<td align="center" height="29px"><a style="color: red;" href="#"
				onclick="zhuangbei()">装备</a></td>
