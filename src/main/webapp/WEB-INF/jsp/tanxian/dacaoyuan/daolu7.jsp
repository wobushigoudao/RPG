...
<link rel="stylesheet" type="text/css"
	href="/RPG/css/tanxian/dacaoyuan/daolu7.css" charset="utf-8" />
	<link rel="stylesheet" type="text/css"
	href="/RPG/css/tanxian/miwusenlin/qugundong.css" charset="utf-8" />
<script type="text/javascript"
	src="/RPG/js/tanxian/dacaoyuan/daolu7.js" charset="utf-8"></script>
	<%@ include file="/WEB-INF/js/tanxian/miwusenlin/laihua-js"%>
</head>
<body class="qugundong">
<span class="daoluqi">道路七</span>
<input type="button" value="道路四" class="xia" onclick="daolusi()">
<input type="button" value="道路九" class="you" onclick="daolujiu()">
