...
<link rel="stylesheet" type="text/css"
	href="/RPG/css/tanxian/dacaoyuan/daolu10.css" charset="utf-8" />
	<link rel="stylesheet" type="text/css"
	href="/RPG/css/tanxian/miwusenlin/qugundong.css" charset="utf-8" />
<script type="text/javascript"
	src="/RPG/js/tanxian/dacaoyuan/daolu10.js" charset="utf-8"></script>
	<%@ include file="/WEB-INF/js/tanxian/miwusenlin/laihua-js"%>
</head>
<body class="qugundong">
<span class="daolushi">道路十</span>
<input type="button" value="象精" class="shang" id="xiangjing" onclick="xiangjing()">
	<input type="button" value="调查" class="diaocha" onclick="diaocha()">
<input type="button" value="道路九" class="xia" onclick="daolujiu()">
