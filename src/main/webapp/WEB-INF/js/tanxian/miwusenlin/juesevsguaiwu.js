window.onload = function() {
	...
	a.src="/RPG/image/tanxian/miwusenlin/"+ming+".png";
	$.ajax({
...
function fa(){
	...
	a.src="/RPG/image/tanxian/miwusenlin/"+ming+"shoushang.png";
...
function wupindonghua(){
	...
	var a=parent.frames["zhandouchang"].document.getElementById("a2");
	if(decodeURI(a.src).indexOf(ming+".png")>0){
	a.src="/RPG/image/tanxian/miwusenlin/"+ming+"cizhuida.png";
	}
	else{
		a.src="/RPG/image/tanxian/miwusenlin/"+ming+".png"
	}
...
function tejidonghua(){
	...
	var a=parent.frames["zhandouchang"].document.getElementById("a2");
	if(decodeURI(a.src).indexOf(ming+".png")>0){
	a.src="/RPG/image/tanxian/miwusenlin/"+ming+"shanguangjianda.png";
	}
	else{
		a.src="/RPG/image/tanxian/miwusenlin/"+ming+".png"
	}
