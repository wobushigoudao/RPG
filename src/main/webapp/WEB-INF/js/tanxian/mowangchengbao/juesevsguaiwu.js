window.onload = function() {
	...
	a.src="/RPG/image/tanxian/mowangchengbao/"+ming+".png";
...
function fa(){
	...
	a.src="/RPG/image/tanxian/mowangchengbao/"+ming+"shoushang.png";
	}
	else{
		a.src="/RPG/image/tanxian/mowangchengbao/"+ming+".png"
	}
...
function wupindonghua(){
	...
	a.src="/RPG/image/tanxian/mowangchengbao/"+ming+"cizhuida.png";
	}
	else{
		a.src="/RPG/image/tanxian/mowangchengbao/"+ming+".png"
	}
...
function tejidonghua(){
	...
	var a=parent.frames["zhandouchang"].document.getElementById("a2");
	if(a.src.indexOf(ming+".png")>0){
	a.src="/RPG/image/tanxian/mowangchengbao/"+ming+"shanguangjianda.png";
	}
	else{
		a.src="/RPG/image/tanxian/mowangchengbao/"+ming+".png"
	}
